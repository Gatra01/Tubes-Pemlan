...
from chatapp.models import Room,Message,User,PersonalChatMessage,PersonalChatRoom
...
class PersonalChatConsumer(AsyncWebsocketConsumer):
    ...
    def save_message(self, message):
        ...
        room = PersonalChatRoom.objects.get(name=self.room_name)
        PersonalChatMessage.objects.create(user=user, room=room, content=message)
